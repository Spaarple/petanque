...
<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center px-4 py-3 bg-gray-50 text-right sm:px-6">
            <a href="{{ route('admin.events.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Créer un événement</a>
        </div>
                    ...
                    @foreach ($events as $event)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.events.show', $event->id) }}" class="text-indigo-600 hover:text-indigo-900">Voir</a>
                                <a href="{{ route('admin.events.edit', $event->id) }}" class="text-indigo-600 hover:text-indigo-900 ml-4">Éditer</a>
