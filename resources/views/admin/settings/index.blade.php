<x-app-layout>
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-8">
        ...
        <div class="mt-8">
            <form action="{{ route('admin.settings.updateCarousel') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
                <div>
                    <label for="carousel_images" class="block text-sm font-medium text-gray-700">Images du Carousel
                        :</label>
            ...
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                @foreach ($carouselImages as $image)
                    <div class="relative group">
                        ...
                        <form action="{{ route('admin.settings.deleteCarouselImage', $image->id) }}" method="POST"
